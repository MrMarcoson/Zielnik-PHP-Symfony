 ...
 */
final class Version20230826180346 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE herb_property (herb_id INT NOT NULL, property_id INT NOT NULL, INDEX IDX_DB1226C6F631D310 (herb_id), INDEX IDX_DB1226C6549213EC (property_id), PRIMARY KEY(herb_id, property_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE ingredient (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, description VARCHAR(2048) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE herb_property ADD CONSTRAINT FK_DB1226C6F631D310 FOREIGN KEY (herb_id) REFERENCES herb (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE herb_property ADD CONSTRAINT FK_DB1226C6549213EC FOREIGN KEY (property_id) REFERENCES property (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE herb_property DROP FOREIGN KEY FK_DB1226C6F631D310');
        $this->addSql('ALTER TABLE herb_property DROP FOREIGN KEY FK_DB1226C6549213EC');
        ...
        $this->addSql('DROP TABLE herb_property');

 ...
 */
final class Version20230827121453 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE recipe ADD author_id INT DEFAULT NULL, ADD date_of_entry DATETIME DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE recipe DROP author_id, DROP date_of_entry');
    }
}
